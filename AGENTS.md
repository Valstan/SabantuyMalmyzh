...
- Деплой — **systemd + nginx + GitHub Actions**, Ubuntu 24.04. Адрес бокса, порт и SSH-алиас в отслеживаемых файлах не держим (D-038): они живут в `secrets` репозитория, оттуда их берут воркфлоу.
