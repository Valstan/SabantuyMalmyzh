 ...
 * (афиша + текст, переданы владельцем 2026-07-02).
 *
...
const EVENTS: Ev[] = [
  {
    ...
    summary: 'Открывает спортивную программу праздника — команды района и гостей.',
    start: at('10:00'),
    end: at('13:00'),
    venue: 'Спортивная площадка',
    category: 'sport',
  },
  {
    slug: 'p2026-podvorye',
  ...
  },
  {
    ...
    summary:
      'Коллективы Балтасинского и Малмыжского районов; специальные гости — семейный дуэт татарской эстрады Зинира и Ризат Рамазановы (г. Казань).',
    start: at('12:00'),
    end: at('14:00'),
    venue: 'Главная сцена',
    category: 'concert',
  ...
  },
  {
    ...
    title: 'Турнир по мини-футболу среди детей',
    summary: 'Детские команды сыграют на центральном стадионе г. Малмыжа.',
    start: at('13:00'),
    end: at('14:00'),
    venue: 'Центральный стадион г. Малмыжа',
    category: 'sport',
  },
  {
    slug: 'p2026-futbol',
    title: 'Турнир по футболу среди взрослых',
    summary: 'Взрослые команды сыграют на центральном стадионе г. Малмыжа.',
    start: at('14:00'),
    end: at('17:00'),
    venue: 'Центральный стадион г. Малмыжа',
    category: 'sport',
