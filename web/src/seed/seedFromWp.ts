...
// 1. Страницы ──────────────────────────────────────────────────────────────
{
  ...
  const privacyHtml =
    ...
    '<p>Настоящая Политика определяет порядок обработки персональных данных посетителей сайта фестиваля «Сабантуй в Малмыже» в соответствии с Федеральным законом № 152-ФЗ «О персональных данных».</p>' +
    ...
    '<h3>Веб-аналитика и cookie</h3>' +
    '<p>Сайт использует сервисы веб-аналитики «Яндекс.Метрика» (ООО «Яндекс») и «LiveInternet» для сбора обезличенной статистики посещаемости с применением cookie-файлов. Собираемые данные (источник перехода, страницы, тип устройства, действия на сайте) не идентифицируют конкретного пользователя и используются исключительно для анализа посещаемости и улучшения сайта. Вы можете отключить cookie в настройках браузера.</p>' +
