...
Приложение живёт в [`web/`](web/). Старт работы с проектом — [`AGENTS.md`](AGENTS.md).
...
| [`AGENTS.md`](AGENTS.md) | **Канон для любого AI-агента**: mailbox-check, правила, карта репо (ADR-0011). `CLAUDE.md`/`GEMINI.md` — тонкие адаптеры к нему |
